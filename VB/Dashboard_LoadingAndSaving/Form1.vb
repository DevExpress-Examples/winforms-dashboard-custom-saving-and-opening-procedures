...
Namespace Dashboard_LoadingAndSaving
	Partial Public Class Form1
        ...
        Private Sub dashboardDesigner1_DashboardOpening(ByVal sender As Object, _
                                      ByVal e As DevExpress.DashboardWin.DashboardOpeningEventArgs) _
                                  Handles dashboardDesigner1.DashboardOpening
